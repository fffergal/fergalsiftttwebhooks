...
#import sys
#
## assuming your django settings file is at '/home/fffergaleu/mysite/mysite/settings.py'
## and your manage.py is is at '/home/fffergaleu/mysite/manage.py'
#path = '/home/fffergaleu/mysite'
#if path not in sys.path:
#    sys.path.append(path)
#
...
#import sys
#
## The "/home/fffergaleu" below specifies your home
## directory -- the rest should be the directory you uploaded your Flask
## code to underneath the home directory.  So if you just ran
## "git clone git@github.com/myusername/myproject.git"
## ...or uploaded files to the directory "myproject", then you should
## specify "/home/fffergaleu/myproject"
#path = '/home/fffergaleu/path/to/flask_app_directory'
#if path not in sys.path:
#    sys.path.append(path)
#
